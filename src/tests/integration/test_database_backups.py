...
def test_all_databases_backed_up(run_rcb_command, mysql_container, mariadb_container, postgres_container):
...
def test_database_health_check(run_rcb_command):
    ...
    assert "is_ready=True" in output, "Database health checks should show databases as ready"
